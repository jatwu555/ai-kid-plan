// botIcon.js —— AI 小伙伴形象（SVG data URI 生成器，自小程序 utils/botIcon.js 移植，SVG 原样保留）
...
window.BotIcon = { svgToDataUri: svgToDataUri, fullBotSvg: fullBotSvg, faceBotSvg: faceBotSvg };
