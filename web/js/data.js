// data.js —— 5 节课数据（自小程序 data/courses.js 同步；改课程内容/视频地址只动这个文件）
// 字段：id / day / title / desc / videoUrl（https 直链）/ rememberToday（重点笔记）
//       taskTitle / taskContent（支持「动词：内容」格式，动词渲染成小标签）/ sayLine（今天请孩子说一句）
const COURSES = [
  {
    id: 1,
    day: 1,
